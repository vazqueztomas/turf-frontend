    ...
    <div className="p-4">
      ...
      {selectedRace && (
        <div className="mt-4 p-4 bg-gray-100 rounded">
          ...
          <p><strong>Número de Carrera:</strong> {selectedRace.number}</p>
          <p><strong>Premio:</strong> {selectedRace.prize}</p>
          <p><strong>Distancia:</strong> {selectedRace.distance}</p>
          <p><strong>Hora:</strong> {selectedRace.time}</p>
            ...
            <table className="min-w-full bg-white border border-gray-300">
              ...
              <tbody>
                {selectedRace.details.map((detail, index) => (
                  <tr key={index}>
                    <td className="py-2 px-4 border border-gray-300">{detail.horse}</td>
                    <td className="py-2 px-4 border border-gray-300">{detail.jockey}</td>
                    <td className="py-2 px-4 border border-gray-300">{detail.trainer}</td>
                    <td className="py-2 px-4 border border-gray-300">{detail.breeder}</td>
                  </tr>
                ))}
              </tbody>
            </table>
